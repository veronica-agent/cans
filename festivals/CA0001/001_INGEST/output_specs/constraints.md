...
- Booth: Go + Charm (bubbletea, lipgloss)
- Mouth: 0.6B clone of a ref wav (same idea as talk). Python/MLX sidecar allowed
- Not Rust for v1
- Not stock Kokoro as Veronica
- Mac-first (this machine). TTFA ≤ 700 ms warm
