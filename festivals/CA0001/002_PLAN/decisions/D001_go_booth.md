...
**Why:** Viral object is the Charm GIF; the clone API is Python/MLX. Pure Go ONNX of Qwen3-TTS is out of scope. Pure Rust is not the booth look and fights the mouth.
